      ...
      <div className="homeBody">
        <section>
          ...
          <p>
            ...
            <br />
            real-estates list Page
            <br />. as well, all of your added banners will appear at the TOP of
            your <br />
            real-estate list page for your own review and in case you like to
            edit
            <br /> any of them,
          </p>
        </section>
        <section>
          <div className="head-home">How to Design your Banner ? </div>
          <p>
        ...
        <section>
          <div className="head-home">
            Maximize your marketing Activities and visitors
          </div>
          <p>
            ...
            <br />
            any of your New ( Business Activities )<br />, as well; This Feature
            allows you to See how much ( Viewers ) Saw
            <br /> any of your ( added banners )
          </p>
        </section>
        <section>
          <div className="head-home">Example of home page banner</div>
        </section>
        <CardHome />
      </div>
    </div>
